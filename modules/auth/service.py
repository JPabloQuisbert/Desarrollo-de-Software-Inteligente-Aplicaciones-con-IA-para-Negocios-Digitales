...
from modules.auth.schema import RegisterInput, LoginInput
from modules.auth.repository import UserRepository


class AuthService:
    """Logica de negocio de autenticacion. Solo responsabilidad: reglas de negocio."""
    ...
    def register(self, input_data: RegisterInput) -> User:
        if self._repo.find_by_email(input_data.email):
            raise ValueError("Ya existe una cuenta con ese correo electronico.")
